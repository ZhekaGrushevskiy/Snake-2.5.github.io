...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    treeImg.src = 'image/tree.svg';

    var benchImg = new Image();
    benchImg.src = 'image/bench.svg';


    var fenceImg = new Image();
    fenceImg.src = 'image/boundaries.svg';
...
var mousecount=10;
    ...
    function draw() {
        ...
        for (let i = 0; i < 250; i = i + fieldOne) {
            context.drawImage(fenceImg, fenceUp.posX + i, fenceUp.posY);
        }
        for (let i = 0; i < 250; i = i + fieldOne) {
            context.drawImage(fenceImg, fenceDown.posX + i, fenceDown.posY);
        }
        localStorage.setItem('score', score);
        var pause = document.getElementById('pause');

        context.drawImage(treeImg, fieldOne, fieldOne * 4);
        context.drawImage(benchImg, fieldOne * 15, fieldOne * 7);
